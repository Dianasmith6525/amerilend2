...
export default function AdminDashboard() {
  ...
  const approveMutation = trpc.loans.adminApprove.useMutation({
    onSuccess: () => {
      ...
      // Trigger admin approval confetti
      const duration = 2000;
  ...
  const handleDisburse = () => {
    ...
    // Validate based on disbursement method
    if (disbursementMethod === "ach" || disbursementMethod === "wire") {
      if (!accountHolderName || !accountNumber || !routingNumber) {
        toast.error(`Please fill in all ${disbursementMethod.toUpperCase()} details`);
        return;
      }
    ...
    disburseMutation.mutate({
      ...
      checkMailingAddress: checkMailingAddress || undefined,
      checkPayeeName: checkPayeeName || undefined,
            ...
            <TabsContent value="fraud" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Review flagged applications with potential fraud risk
                  </CardDescription>
                </CardHeader>
              </Card>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium">High Risk (Score 80+)</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-2xl font-bold text-red-600">AUTO-REJECTED</p>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium">Medium Risk (Score 50-80)</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-2xl font-bold text-yellow-600">MANUAL REVIEW</p>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium">Low Risk (Score 0-50)</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-2xl font-bold text-green-600">AUTO-APPROVED</p>
                    <p className="text-xs text-muted-foreground mt-1">Normal processing</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Fraud Detection Factors</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <p className="font-semibold text-sm">Automatic Blocks:</p>
                      <ul className="text-sm space-y-1 text-muted-foreground">
                        <li>✓ SSN already in system</li>
                        <li>✓ 2+ apps in 24 hours</li>
                        <li>✓ Invalid SSN pattern</li>
                    ...
                    <div className="space-y-2">
                      ...
                      <ul className="text-sm space-y-1 text-muted-foreground">
                        ...
                        <li>• Loan &gt; 6x monthly income</li>
                        <li>• Recent bankruptcy filing</li>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Applications flagged for manual review (Score 50-80)
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="text-center py-8 text-muted-foreground">
                    <p>Flagged applications will appear here</p>
                    <p className="text-xs mt-2">System is monitoring all new applications</p>
                  </div>
                </CardContent>
              </Card>
            </TabsContent>
      ...
      <Dialog open={disbursementDialog.open} onOpenChange={(open) => setDisbursementDialog({ ...disbursementDialog, open })}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Select disbursement method and enter required details
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4 max-h-96 overflow-y-auto">
            ...
            <div className="space-y-2">
              ...
              <Select value={disbursementMethod} onValueChange={(value: any) => {
                ...
                <SelectContent>
                  <SelectItem value="ach">
                    <div>
                      <p className="font-medium">ACH (Direct Deposit)</p>
                  ...
                  <SelectItem value="check">
                    <div>
                      <p className="font-medium">Paper Check</p>
                      <p className="text-xs text-gray-500">5-7 business days</p>
                    </div>
                  </SelectItem>
                  <SelectItem value="paycard">
                    <div>
            ...
            {(disbursementMethod === "ach" || disbursementMethod === "wire") && (
              <>
                <div className="space-y-2">
            ...
            {/* Wire Transfer Additional Fields */}
            ...
            {disbursementMethod === "check" && (
              <>
                <div className="space-y-2">
                  <Label htmlFor="checkPayeeName">Payee Name</Label>
                  <Input
                    id="checkPayeeName"
                    value={checkPayeeName}
                    onChange={(e) => setCheckPayeeName(e.target.value)}
                    placeholder="Name check should be payable to"
                  />
                </div>
                <div className="space-y-2">
            ...
            {/* Common Notes Field */}
            <div className="space-y-2">
              <Label htmlFor="disbursementNotes">Admin Notes (optional)</Label>
              <Textarea
